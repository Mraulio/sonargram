...
function IndexPage() {  
  ...
  return (
    ...
    <Box sx={{ display: 'flex', flexDirection: 'row', alignItems: 'end', justifyContent: 'center', height: '100vh', width: '100vw', backgroundImage: `url(assets/images/imagen.jpg)`, backgroundSize: 'cover', backgroundPosition: 'center', backgroundRepeat: 'no-repeat', gap: 10 }}>
