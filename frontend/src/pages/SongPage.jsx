...
useEffect(() => {
  const fetchFavorites = async () => {
    try {
      ...
      const songFavorites = data.filter(item => item.favoriteType === "song");
  ...
  return (  
    ...
    <Box sx={{ padding: 2 }}>
        <Menu/>
        <Typography variant="h4" gutterBottom>Hola! aquí aparecerán las canciones favoritas del usuario.</Typography>
    </Box>
